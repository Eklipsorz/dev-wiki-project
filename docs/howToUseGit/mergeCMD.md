...
![](https://res.cloudinary.com/dqfxgtyoi/image/upload/v1633009938/blog/git/merge/mergeBefore_xgwd8d.png)
...
![](https://res.cloudinary.com/dqfxgtyoi/image/upload/v1633009939/blog/git/merge/mergeSelection_ezyhjr.png)
...
然而最後產生的節點圖並不會以上頭的排序結果來重新或者合併一個分支來呈現，而是將兩個分支上的需要重排(原本在橘框的)節點重新按照提交時間在原分支上進行排序，最後會在主分支Branch1產生一個額外的commit N"來表示合併已經完成。
![](https://res.cloudinary.com/dqfxgtyoi/image/upload/v1633009939/blog/git/merge/mergeAfter_kpdhkr.png)
